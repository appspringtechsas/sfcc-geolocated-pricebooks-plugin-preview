...
import {HeartIcon, HeartSolidIcon} from '@appspringtechsas/sfcc-geolocated-pricebooks-plugin/app/components/icons'
...
import DynamicImage from '@appspringtechsas/sfcc-geolocated-pricebooks-plugin/app/components/dynamic-image'

// Hooks
import {useIntl} from 'react-intl'

// Other
import {productUrlBuilder} from '@appspringtechsas/sfcc-geolocated-pricebooks-plugin/app/utils/url'
    ...
    return (
        ...
        >
            ...
            <Text {...styles.price} data-testid="product-tile-price">
                ...
                {formatPrice(intl, price, currency, activeCurrency)}
            </Text>
        </Link>
    )
}
